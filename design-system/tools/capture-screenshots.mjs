/**
 * Regenerates every screenshot in design-system/images from the static
 * specimen pages (docs/mocks/design-system.html and
 * design-system/specimens/extras.html).
 *
 * Usage: node design-system/tools/capture-screenshots.mjs
 *
...
const PAGES = [
  ...
  {
    file: "design-system/specimens/extras.html",
    shots: {
