      ...
      <div className="space-y-3">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-0.5">
            Select all that apply. At least one of Indigenous Leader, Indigenous Individual,
            or Non-Indigenous Individual is required.
          </p>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          {PARTICIPATION_CATEGORIES.map(({ value, label }) => (
            <div key={value} className="flex items-center gap-3 p-3 rounded-lg border border-border hover:bg-muted/50 cursor-pointer"
