...
export async function updateSession(request: NextRequest) {
  // Keep the documented mock-data development mode usable without Supabase.
  ...
  const publicRoutes = ["/", "/demo", "/auth/login", "/auth/verify", "/auth/callback"];
