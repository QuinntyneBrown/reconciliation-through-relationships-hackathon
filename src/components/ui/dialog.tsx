...
function DialogHeader({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("flex flex-col gap-1 px-6 pt-5 pr-20", className)}
      {...props}
    />
  );
}
...
function DialogKicker({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
...
function DialogFooter({
  ...
  return (
    <div
      ...
      className={cn(
        "flex flex-col-reverse flex-wrap gap-3 px-6 pt-4 pb-5 sm:flex-row sm:justify-end",
        className,
      )}
      {...props}
    >
