  ...
  return (
    <div className="space-y-8">
      ...
      <div className="space-y-4">
        <Label className="text-base font-medium">Which factors are important in your match?</Label>
      ...
      <div className="space-y-2">
        ...
        <p className="text-muted-foreground text-sm">
          Anything you&apos;d like a facilitator to know when making your match — topics you&apos;re
          not comfortable discussing, accessibility needs, or other preferences.
        </p>
        <Textarea
      ...
      <div className="border-border bg-muted/30 flex items-start gap-3 rounded-lg border p-4">
        ...
        <div>
          ...
          <p className="text-muted-foreground mt-0.5 text-sm">
            I consent to my city (not my exact address) being shown on the participant map to help
            facilitators identify local reconciliation cohorts. This is optional.
          </p>
        </div>
      </div>

      <div className="border-border bg-muted/30 text-muted-foreground rounded-lg border p-4 text-sm">
        <p className="text-foreground mb-1 font-medium">Privacy commitment</p>
        <p>
          Your personal information is only shared with your matched connection and RTR
          facilitators. Your exact location is never shown to other participants. You can update or
