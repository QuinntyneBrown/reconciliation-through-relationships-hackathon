    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="text-muted-foreground mt-1">
          Location helps us connect you with people in your region and identify local reconciliation
          cohorts. Only your city will be shown on the map — never your exact address.
        </p>
      </div>
